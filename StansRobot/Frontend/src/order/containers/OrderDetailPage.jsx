...
import getCityDetailData from '../services/getCityDetailData'
...
const [addressDetailData, setAddressDetailData] = useState()
	const [cityDetailData, setCityDetailData] = useState()
useEffect(() => {
		const fetchData = async () => {
			try {
				setIsLoading(prev => ({...prev, addressDetail: true}))
				const { data: addressDetailData } = await getAddressDetailData({ addressId, addressId })
				const { data: cityDetailData } = await getCityDetailData({ addressId, addressId })
				setAddressDetailData(addressDetailData.data)
				setCityDetailData(cityDetailData.data)
			} finally {
