...
java -cp webshop.product.eshoponcontainerspaymentorder --module-path webshop.product.eshoponcontainerspaymentorder -m webshop.product.eshoponcontainerspaymentorder 2>&1 | tee java.log &
JAVA_PID=$!
TEE_PID=$(pgrep -n tee)
