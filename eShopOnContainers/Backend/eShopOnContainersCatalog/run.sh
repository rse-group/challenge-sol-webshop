...
java -cp webshop.product.eshoponcontainerscatalog --module-path webshop.product.eshoponcontainerscatalog -m webshop.product.eshoponcontainerscatalog 2>&1 | tee java.log &
JAVA_PID=$!
TEE_PID=$(pgrep -n tee)
