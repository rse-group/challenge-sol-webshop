...
java -cp webshop.product.eshoponcontainersorder --module-path webshop.product.eshoponcontainersorder -m webshop.product.eshoponcontainersorder 2>&1 | tee java.log &
JAVA_PID=$!
TEE_PID=$(pgrep -n tee)
