...
import AddressDetailPage from './containers/AddressDetailPage'
...
{ 
    path: "/profile",
    element: <RequireAuth permissionNeeded="ViewCustomer" ><ProfilePage/></RequireAuth>
  }	
,
{ 
    path: "/profile/address/:addressId",
    element: <RequireAuth permissionNeeded="ViewCustomer" ><AddressDetailPage/></RequireAuth>
  }	
