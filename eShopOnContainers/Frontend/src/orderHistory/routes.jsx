...
import CancelOrderPage from './containers/CancelOrderPage'
...
,
{ 
    path: "/order-history/:orderId/cancel",
    element: <RequireAuth permissionNeeded="CancelOrder" ><CancelOrderPage/></RequireAuth>
  }	
